...
public class RegisterCustomerForm {
    ...
    public RegisterCustomerForm(int order, int comment, int employee, String password, String cpassword, String username, String lastname, String firstname, String phone, String addressline1, String addressline2, String city, String state, String postalCode, String country, String email, Status status) {
        this.order = order;
